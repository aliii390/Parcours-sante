 ...
 */
final class Version20260704113425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medicament DROP actif');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medicament ADD actif TINYINT NOT NULL');

 ...
 */
final class Version20260709110903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prise_medicament (id INT AUTO_INCREMENT NOT NULL, heure_prevue DATETIME NOT NULL, nombres_comprimes INT NOT NULL, effectuee TINYINT NOT NULL, medicament_id INT DEFAULT NULL, INDEX IDX_9A13DBE4AB0D61F7 (medicament_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

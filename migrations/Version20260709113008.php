 ...
 */
final class Version20260709113008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prise_medicament DROP effectuee');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prise_medicament ADD effectuee TINYINT NOT NULL');

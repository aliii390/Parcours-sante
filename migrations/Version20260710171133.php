 ...
 */
final class Version20260710171133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal DROP symptome');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal ADD symptome VARCHAR(255) NOT NULL');

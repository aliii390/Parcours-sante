 ...
 */
final class Version20260710171228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal ADD symptome_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE journal ADD CONSTRAINT FK_C1A7E74D12B83D77 FOREIGN KEY (symptome_id) REFERENCES symptome (id)');
        $this->addSql('CREATE INDEX IDX_C1A7E74D12B83D77 ON journal (symptome_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C1A7E74D12B83D77 ON journal');
        $this->addSql('ALTER TABLE journal DROP symptome_id');

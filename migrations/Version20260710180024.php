 ...
 */
final class Version20260710180024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal ADD user_id INT DEFAULT NULL, CHANGE intensite intensite SMALLINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE journal DROP user_id, CHANGE intensite intensite INT NOT NULL');

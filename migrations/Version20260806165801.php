 ...
 */
final class Version20260806165801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prise_medicament ADD user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE prise_medicament ADD CONSTRAINT FK_9A13DBE4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_9A13DBE4A76ED395 ON prise_medicament (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prise_medicament DROP FOREIGN KEY FK_9A13DBE4A76ED395');
        $this->addSql('DROP INDEX IDX_9A13DBE4A76ED395 ON prise_medicament');
        $this->addSql('ALTER TABLE prise_medicament DROP user_id');

 ...
 */
final class Version20260824142153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prise_rdv (id INT AUTO_INCREMENT NOT NULL, heure TIME NOT NULL, jour DATETIME NOT NULL, valider TINYINT NOT NULL, rdv_id INT DEFAULT NULL, INDEX IDX_467916924CCE3F86 (rdv_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE prise_rdv ADD CONSTRAINT FK_467916924CCE3F86 FOREIGN KEY (rdv_id) REFERENCES rendez_vous (id)');
        $this->addSql('DROP TABLE notif_rendez_vous');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notif_rendez_vous (id INT AUTO_INCREMENT NOT NULL, heure_prevue TIME NOT NULL, jour DATETIME NOT NULL, valider TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prise_rdv DROP FOREIGN KEY FK_467916924CCE3F86');
